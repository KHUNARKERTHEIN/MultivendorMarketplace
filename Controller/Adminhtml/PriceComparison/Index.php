...
class Index extends \Magento\Backend\App\Action
{
    ...
    /**
     * Initialize Price Comparison Product Controller
     *
    ...
    public function execute()
    {
        ...
        $ksResultPage->setActiveMenu('Ksolves_MultivendorMarketplace::manage_price_comparison_products');
        $ksResultPage->getConfig()->getTitle()->prepend(__('Price Comparison Products'));
        return $ksResultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Ksolves_MultivendorMarketplace::manage_price_comparison_products');
    }
}
