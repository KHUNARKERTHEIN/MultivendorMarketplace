...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $ksResultPage->setActiveMenu('Ksolves_MultivendorMarketplace::manage_products');
        $ksResultPage->getConfig()->getTitle()->prepend(__('Seller Products'));
        return $ksResultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Ksolves_MultivendorMarketplace::all_products');
    }
}
