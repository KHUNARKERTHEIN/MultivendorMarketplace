 ...
 * KsGiftmessage block
 */
class KsGiftmessage extends \Magento\Framework\View\Element\Template
{
    /**
    ...
    public function getEntity()
    {
        if ($this->_entity === null) {
            ...
            $this->getEntity()->load($this->getRequest()->getParam('ks_order_id'));
        }
        return $this->_entity;
    }
    ...
    {
        return $this->getUrl(
            'multivendor/order/savegiftmessage',
     ...
     * @return string
     */
    public function checkGiftMessageEditAllowed()
    {
        return $this->ksScopeConfig->isSetFlag(
            'ks_marketplace_sales/ks_order_settings/ks_edit_gift_messages',
     ...
     * @return string
     */
    public function getKsCommentAjaxUrl()
    {
        return $this->getUrl('*/*/addComment', ['order_id' => $this->getEntity()->getId()]);
    }
}
