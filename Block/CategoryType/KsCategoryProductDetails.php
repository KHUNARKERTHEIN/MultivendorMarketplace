...
namespace Ksolves\MultivendorMarketplace\Block\CategoryType;
 ...
 */
class KsCategoryProductDetails extends \Magento\Framework\View\Element\Template
{
    /**
     * @var ProductFactory
     */
    ...
    public function getCategoryProductCollection()
    {
        ...
        $ksCollection = $this->ksCatalogProductFactory->create()
    ...
    {
        $ksCategoryCollection = $this->ksSellerCategoryCollection->create()
                        ->addFieldToFilter('ks_seller_id', (int)$this->getRequest()->getParam('ks_seller_id'))
                        ->addFieldToFilter('ks_category_id', $this->getRequest()->getParam('ks_category_id'))
                        ->addFieldToFilter('ks_category_status', 0);
