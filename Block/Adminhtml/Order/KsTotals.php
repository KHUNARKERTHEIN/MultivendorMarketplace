...
class KsTotals extends \Ksolves\MultivendorMarketplace\Block\Adminhtml\KsTotals
{
    ...
    public function __construct(
        ...
        parent::__construct($ksContext, $ksRegistry, $ksAdminHelper, $data);
    }
    ...
    protected function _initTotals()
    {
        ...
        $this->_totals['commission'] = new \Magento\Framework\DataObject(
            [
                ...
                'base_value' => $this->ksOrderHelper->getKsAdminTotalBaseOrderCommission($this->getSource()->getRealOrderId()),
