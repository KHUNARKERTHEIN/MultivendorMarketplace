...
namespace Ksolves\MultivendorMarketplace\Block\Adminhtml\Order\View;
 ...
 * Info class
 */
class Info extends \Ksolves\MultivendorMarketplace\Block\Adminhtml\Order\KsAbstractOrder
{
    /**
     * Customer service
     *
    ...
    {
        return $this->getUrl('multivendor/order/view', ['ks_order_id' => $orderId]);
    }
