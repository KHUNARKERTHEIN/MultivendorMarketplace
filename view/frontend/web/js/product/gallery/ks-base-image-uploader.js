    ...
    $.widget('mage.ksBaseImage', {
        ...
        _create: function () {
            var $container = this.element,
                ...
                $dropPlaceholder = this.element.find('.ks-image-placeholder'),
            ...
            var findElement = function (data) {
                return $container.find('.image:not(.ks-image-placeholder)').filter(function () {
                    if (!$(this).data('image')) {
                        return false;
                    }
            ...
            $container.sortable({
                axis: 'x',
                items: '.image:not(.ks-image-placeholder)',
                distance: 8,
                tolerance: 'pointer',
            ...
            this.element.find('input[type="file"]').fileupload({
                ...
                start: function (event) {
                    var uploaderContainer = $(event.target).closest('.ks-image-placeholder');
