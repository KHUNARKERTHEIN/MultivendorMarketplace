...
define([
    ...
    'underscore',
    'ko',
    'Ksolves_MultivendorMarketplace/js/product/ks-notification'
], function (Component, $, bootstrap, _, ko) {
    'use strict';
    ...
    return Component.extend({
        ...
        initialize: function (options) { 
            this._super(options);
            ko.cleanNode($(this.gridSelector)[0]);    
            ...
            this.variationsComponent(function (variation) {
                this._switchProductType(variation.productMatrix());
            }.bind(this));
        },
        ...
        _initGrid: function (filterData) {
            ...
            $.ajax({
                ...
                $(self.gridSelector).html(data);
                $(self.gridSelector).trigger('contentUpdated');
                $(self.gridSelector).applyBindings();
            });
        },
