...
define([
    ...
    'mage/translate',
    'Ksolves_MultivendorMarketplace/js/product/variations/ks-variations'
    ...
    return Component.extend({
        ...
        getImageProperty: function (node) {
            var types = node.find('[data-role=gallery]').ksProductGallery('option').types,
