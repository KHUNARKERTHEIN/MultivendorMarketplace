...
define([
    ...
    'jquery/ui',
    'validation'
], function (jQuery, url, mageTemplate, rg) {
    'use strict';
    ...
    return function (config) {
        var swatchOptionVisualDefaultInputType = 'radio',
            swatchVisualOption = {
                ...
                ignoreValidate: function () {
                    ...
                    jQuery('#ks_productattribute_form').data('validator').settings.forceIgnore = ignore;
                }
            };
        ...
        jQuery('#swatch-visual-options-panel').ready(function () {
            ...
            var swatchComponents = {
                ...
                create: function () {
                    ...
                    this.form = $('<form />', {
                        ...
                        action: url.build('multivendor/productattribute/show/')+'key/'+randomString(64, '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ')
                    }).appendTo(this.wrapper);
