...
define([
    ...
    return function (ksConfig) {
        var optionPanel = jQuery('#manage-options-panel'),
            editForm = jQuery('#ks_productattribute_form'),
            attributeOption = {
                ...
                isReadOnly: ksConfig.isReadOnly,
        ...
        optionPanel.ready(function () {
            ...
            attributeOption.renderWithDelay(ksConfig.attributesData, 0, 100, 300);
            attributeOption.bindRemoveButtons();
        });

        if (ksConfig.isSortable) {
            jQuery(function ($) {
