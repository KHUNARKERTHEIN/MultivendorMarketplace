...
/**
 * Class KsCreditmemoList
 */
class KsCreditmemoList extends AbstractDataProvider
{
    /**
     * ks_sales_creditmemo collection
     *
     * @var Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesCreditMemo\Collection
     */
    ...
    public function __construct(
        ...
        $this->collection->getSelect()->join(
            ...
            [
                ...
                'ks_creditmemo_increment_id'       =>'main_table.ks_creditmemo_increment_id',
                'status',
                'base_grand_total',
                'subtotal',
                'created_at',
