...
/**
 * Class KsPendingPriceComparisonDataProvider
 * @package Ksolves\MultivendorMarketplace\Ui\DataProvider\Backend
 */
class KsPendingPriceComparisonDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
    ...
    public function __construct(
        ...
        $this->collection->joinField(
            ...
            [],
            'left'
        )->addFieldToFilter('ks_seller_id', ['neq'=>''])->addFieldToFilter('ks_parent_product_id', ['neq' => 0]);
