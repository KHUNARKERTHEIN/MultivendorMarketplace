...
/**
 * Class KsChildProductDataProvider
 * @package Ksolves\MultivendorMarketplace\Ui\DataProvider\Backend
 */
class KsChildProductDataProvider extends \Ksolves\MultivendorMarketplace\Ui\DataProvider\Backend\Product\Listing\KsCatalogProductDataProvider
{
    ...
    */
    ...
    /**
     * KsChildProductDataProvider constructor.
     * @param string $name
    ...
    public function __construct(
        ...
        $ksAssociatedProductIds = $this->ksProductHelper->getKsChildProductIds($ksProductId);
        // Filter according to seller id
