...
/**
 * Class KsCustomerOrdersList
 */
class KsCustomerOrdersList extends AbstractDataProvider
{
    /**
    ...
    public function __construct(
        ...
        )->where("main_table.ks_seller_id = '$ks_sellerId'")->where("sog.customer_id='$ksCustomerId'");
        $this->collection->getSelect()->limit(5);
    }
