...
/**
 * Class KsPriceComparisonProductList
 * @package Ksolves\MultivendorMarketplace\Ui\DataProvider\Frontend
 */
class KsPriceComparisonProductList extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct($name, $ksPrimaryFieldName, $ksRequestFieldName, $meta, $data);
