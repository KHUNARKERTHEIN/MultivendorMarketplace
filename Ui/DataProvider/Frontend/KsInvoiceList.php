 ...
 * Class KsInvoiceList
 */
class KsInvoiceList extends AbstractDataProvider
{
    /**
     * ks_sales_invoice collection
     *
     * @var Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesInvoice\Collection
     */
    ...
    public function __construct(
        ...
        $this->collection->getSelect()->join(
            ...
            [
                ...
                'ks_invoice_increment_id' => 'main_table.ks_invoice_increment_id',
                'status',
                'base_grand_total',
                'subtotal',
                'created_at',
