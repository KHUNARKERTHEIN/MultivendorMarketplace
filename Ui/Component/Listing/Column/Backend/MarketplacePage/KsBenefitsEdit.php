...
/**
 * Class KsBenefitsEdit
 */
class KsBenefitsEdit extends \Magento\Ui\Component\Listing\Columns\Column
{
    const URL_PATH_EDIT = 'multivendor/benefits/edit';
    const URL_PATH_DELETE = 'multivendor/benefits/delete';
