...
/**
 * KsSellerReportSubReason Ui Class
 */
class KsSellerReportSubReason extends Column
{
    const KS_URL_PATH_EDIT = 'multivendor/reportseller/newsubreason';
