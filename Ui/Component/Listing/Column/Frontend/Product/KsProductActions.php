...
/**
 * KsProductActions Ui Class
 */
class KsProductActions extends Column
{
    /**
     * Urls for actions
     */
    public const KS_URL_PATH_EDIT = 'multivendor/product/edit';
    public const KS_URL_PATH_REQUEST_FOR_APPROVAL = 'multivendor/product/productrequest';
