...
namespace Ksolves\MultivendorMarketplace\Model\Banners;

use Ksolves\MultivendorMarketplace\Model\ResourceModel\KsBanners\CollectionFactory;
use Magento\Store\Model\StoreManagerInterface;

/**
 * KsBannersDataProvider
 */
class KsBannersDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
    ...
    public function getData()
    {
        ...
        foreach ($ksItems as $ksData) {
            $this->loadedData[$ksData->getId()]['banners'] = $ksData->getData();
            if ($ksData->getKsPicture()) {
                ...
                $this->loadedData[$ksData->getId()]['banners'] = array_merge($ksFullData[$ksData->getId()]['banners'], $ksImage);
            }
        }
        return $this->loadedData;
    }
