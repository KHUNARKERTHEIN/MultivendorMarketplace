...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesShipmentItem;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $this->_init(
            'Ksolves\MultivendorMarketplace\Model\KsSalesShipmentItem',
            'Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesShipmentItem'
        );
        parent::__construct(
            $ksEntityFactory,
            $ksLogger,
