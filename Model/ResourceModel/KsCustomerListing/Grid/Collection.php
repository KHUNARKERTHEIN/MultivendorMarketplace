...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsCustomerListing\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Ksolves\MultivendorMarketplace\Model\ResourceModel\KsCustomerListing\Collection as KsCustomerCollection;
use Ksolves\MultivendorMarketplace\Helper\KsSellerHelper;

/**
 * Class Collection
 * Collection for displaying grid of customer
 */
class Collection extends KsCustomerCollection implements SearchResultInterface
{
    /**
