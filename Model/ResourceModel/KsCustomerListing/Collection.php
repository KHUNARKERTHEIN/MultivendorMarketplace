...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsCustomerListing;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $this->_init(
            'Ksolves\MultivendorMarketplace\Model\KsCustomerListing',
            'Ksolves\MultivendorMarketplace\Model\ResourceModel\KsCustomerListing'
        );
        parent::__construct(
            $ksEntityFactory,
            $ksLogger,
