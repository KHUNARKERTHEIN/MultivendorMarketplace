...
/**
 * Class SellerPendingListCollection
 * Collection for displaying grid of seller pending
 */
class SellerPendingListCollection extends KsSellerCollection implements SearchResultInterface
{
    /**
    ...
    protected function _renderFiltersBefore()
    {
        ...
        )->where('main_table.ks_seller_status=0');
