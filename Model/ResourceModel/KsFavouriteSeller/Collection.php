...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsFavouriteSeller;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $this->_init(
            'Ksolves\MultivendorMarketplace\Model\KsFavouriteSeller',
            'Ksolves\MultivendorMarketplace\Model\ResourceModel\KsFavouriteSeller'
        );
        parent::__construct(
            $ksEntityFactory,
            $ksLogger,
