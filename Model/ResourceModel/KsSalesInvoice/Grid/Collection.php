...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesInvoice\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesInvoice\Collection as KsSalesInvoiceCollection;
use Ksolves\MultivendorMarketplace\Helper\KsSellerHelper;

/**
 * Class Collection
 * Collection for displaying grid of invoice
 */
class Collection extends KsSalesInvoiceCollection implements SearchResultInterface
{
    /**
    ...
    /**
     * Join sales order grid table for order details
     *
     * @return void
     */
