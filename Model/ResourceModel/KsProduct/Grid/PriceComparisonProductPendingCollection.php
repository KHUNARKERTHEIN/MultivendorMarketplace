...
/**
 * Class PriceComparisonProductPendingCollection
 * @package Ksolves\MultivendorMarketplace\Model\ResourceModel\KsProduct\Grid
 */
class PriceComparisonProductPendingCollection extends KsProductCollection implements SearchResultInterface
{
    /**
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $this->addFieldToFilter('ks_product_approval_status', \Ksolves\MultivendorMarketplace\Model\KsProduct::KS_STATUS_PENDING);
