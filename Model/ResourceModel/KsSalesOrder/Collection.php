...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesOrder;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $this->_init(
            'Ksolves\MultivendorMarketplace\Model\KsSalesOrder',
            'Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesOrder'
        );
        parent::__construct(
            $ksEntityFactory,
            $ksLogger,
