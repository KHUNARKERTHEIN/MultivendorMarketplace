...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesInvoiceItem;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $this->_init(
            'Ksolves\MultivendorMarketplace\Model\KsSalesInvoiceItem',
            'Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesInvoiceItem'
        );
        parent::__construct(
            $ksEntityFactory,
            $ksLogger,
