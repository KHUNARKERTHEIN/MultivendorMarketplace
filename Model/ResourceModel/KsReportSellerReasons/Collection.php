...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsReportSellerReasons;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $this->_init(
            'Ksolves\MultivendorMarketplace\Model\KsReportSellerReasons',
            'Ksolves\MultivendorMarketplace\Model\ResourceModel\KsReportSellerReasons'
        );
        parent::__construct(
            $ksEntityFactory,
            $ksLogger,
