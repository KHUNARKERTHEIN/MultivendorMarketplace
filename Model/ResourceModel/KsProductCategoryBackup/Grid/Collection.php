...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsProductCategoryBackup\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Ksolves\MultivendorMarketplace\Model\ResourceModel\KsProductCategoryBackup\Collection as KsProductCategoryBackupCollection;

/**
 * Class Collection
 * Collection for displaying grid of product category backup
 */
class Collection extends KsProductCategoryBackupCollection implements SearchResultInterface
{
    /**
