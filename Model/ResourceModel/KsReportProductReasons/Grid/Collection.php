...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsReportProductReasons\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Ksolves\MultivendorMarketplace\Model\ResourceModel\KsReportProductReasons\Collection as KsReportProductReasonsCollection;

/**
 * Class Collection
 * Collection for displaying grid of report product reasons
 */
class Collection extends KsReportProductReasonsCollection implements SearchResultInterface
{
    /**
