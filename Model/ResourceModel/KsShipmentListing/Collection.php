...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsShipmentListing;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $this->_init(
            'Ksolves\MultivendorMarketplace\Model\KsShipmentListing',
            'Ksolves\MultivendorMarketplace\Model\ResourceModel\KsShipmentListing'
        );
        parent::__construct(
            $ksEntityFactory,
            $ksLogger,
