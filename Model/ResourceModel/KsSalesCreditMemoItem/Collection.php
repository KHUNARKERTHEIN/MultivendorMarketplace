...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesCreditMemoItem;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $this->_init(
            'Ksolves\MultivendorMarketplace\Model\KsSalesCreditMemoItem',
            'Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSalesCreditMemoItem'
        );
        parent::__construct(
            $ksEntityFactory,
            $ksLogger,
