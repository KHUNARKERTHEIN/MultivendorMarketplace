...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsOrdersListing;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $this->_init(
            'Ksolves\MultivendorMarketplace\Model\KsOrdersListing',
            'Ksolves\MultivendorMarketplace\Model\ResourceModel\KsOrdersListing'
        );
        parent::__construct(
            $ksEntityFactory,
            $ksLogger,
