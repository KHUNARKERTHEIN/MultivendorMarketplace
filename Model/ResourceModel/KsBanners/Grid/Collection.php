...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsBanners\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Ksolves\MultivendorMarketplace\Model\ResourceModel\KsBanners\Collection as KsBannersCollection;
use Magento\Framework\App\Request\Http;

/**
 * Class Collection
 * Collection for displaying grid of category request
 */
class Collection extends KsBannersCollection implements SearchResultInterface
{
    /**
    ...
    public function __construct(
        ...
        $this->ksRequest    = $ksRequest->getParam('seller_id');
    ...
    protected function _renderFiltersBefore()
    {
        ...
        )->where("ks_cgf.entity_id = " . $this->ksRequest);
