...
namespace Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSellerStore;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $this->_init(
            'Ksolves\MultivendorMarketplace\Model\KsSellerStore',
            'Ksolves\MultivendorMarketplace\Model\ResourceModel\KsSellerStore'
        );
        parent::__construct(
            $ksEntityFactory,
            $ksLogger,
