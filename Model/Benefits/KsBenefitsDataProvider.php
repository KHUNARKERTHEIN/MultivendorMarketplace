...
namespace Ksolves\MultivendorMarketplace\Model\Benefits;

use Ksolves\MultivendorMarketplace\Model\ResourceModel\KsBenefits\CollectionFactory;
use Magento\Store\Model\StoreManagerInterface;

/**
 * KsBenefitsDataProvider
 */
class KsBenefitsDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
    ...
    public function getData()
    {
        ...
        foreach ($ksItems as $ksData) {
            $this->loadedData[$ksData->getId()]['benefits'] = $ksData->getData();
            if ($ksData->getKsPicture()) {
                ...
                $this->loadedData[$ksData->getId()]['benefits'] = array_merge($ksFullData[$ksData->getId()]['benefits'], $ksImage);
            }
        }
        return $this->loadedData;
    }
