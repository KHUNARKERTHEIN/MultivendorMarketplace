...
/**
 * KsMapStyles SellerLocator Model Class
 */
class KsMapStyles implements ArrayInterface
{
    ...
    {
        $ksOptions = [];
        foreach ($this->toArray() as $ksValue => $ksLabel) {
            $ksOptions[] = [
                'value' => $ksValue,
                'label' => $ksLabel
            ];
     ...
     * @return mixed
     */
    public function getKsMapData($ksStyle)
    {
        return self::MAP_DATA[$ksStyle];
    }
}
