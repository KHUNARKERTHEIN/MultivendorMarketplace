 ...
 */
class KsCreditmemo extends \Magento\Sales\Model\Order\Pdf\Creditmemo
{
    /**
    ...
    public function getPdf($creditmemos = [])
    {
        ...
        foreach ($creditmemos as $creditmemo) {
            if ($creditmemo->getStoreId()) {
                ...
                $this->ksStoreManager->setCurrentStore($creditmemo->getStoreId());
            }
            $page = $this->newPage();
            $order = $creditmemo->getOrder();
            $ksMemoIncId = $creditmemo->getIncrementId();
            $ksSellerId = $this->ksOrderHelper->getKsIsSellerMemo($ksMemoIncId);
            /* Add image */
