 ...
 */
class KsInvoice extends \Magento\Sales\Model\Order\Pdf\Invoice
{
    /**
    ...
    public function getPdf($invoices = [])
    {
        ...
        foreach ($invoices as $invoice) {
            if ($invoice->getStoreId()) {
                ...
                $this->ksStoreManager->setCurrentStore($invoice->getStoreId());
            }
            $page = $this->newPage();
            $order = $invoice->getOrder();
            $ksInvoiceIncId = $invoice->getIncrementId();
            $ksSellerId = $this->ksOrderHelper->getKsIsSellerInvoice($ksInvoiceIncId);
            /* Add image */
