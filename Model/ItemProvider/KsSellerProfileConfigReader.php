...
/**
 * Class KsSellerConfigReader
 * @package Ksolves\MultivendorMarketplace\Model\ItemProvider
 */
class KsSellerProfileConfigReader implements ConfigReaderInterface
{
    const KS_XML_PATH_CHANGE_FREQUENCY = 'ks_marketplace_sitemap/ks_sitemap/ks_profile_frequency';
    const KS_XML_PATH_PRIORITY = 'ks_marketplace_sitemap/ks_sitemap/ks_profile_priority';
    const KS_XML_PATH_SELLER_SITEMAP_STATUS = 'ks_marketplace_sitemap/ks_sitemap/ks_enable_sitemap';
    const KS_XML_PATH_INCLUDE_PROFILE_URL = 'ks_marketplace_sitemap/ks_sitemap/ks_include_seller_profile_url';
    ...
    */
     ...
     * @return string
    */
    public function getKsIncludeProfileUrl($ksStoreId)
    {
        $ksStoreId = (int)$ksStoreId;
        return $this->getKsConfigValue(self::KS_XML_PATH_INCLUDE_PROFILE_URL, $ksStoreId);
    }
